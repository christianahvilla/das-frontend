...
export const APPOINTMENT_PATTIENT = 'Paciente';
...
export const APPOINTMENT_PATTIENT_KEY = 'pattient';
export const APPOINTMENT_MEDICATION_KEY = 'medication';
...
export const APPOINTMENT_PATTIENT_ERROR = 'Selecciona un paciente';
